...
class Fun(commands.Cog):
    def __init__(self, bot) -> None:
        self.bot = bot
        self.randomAnswerBall = ['Духи говорят "Да". Число пи...', 'Конечно нет, ты шо?', 'Я глухой, повтори.', 'Э-э-э-э. А? Ч-что ты имеешь виду?', 'Да', 'Я не знаю(тут моя фонтазия кончилась).']
